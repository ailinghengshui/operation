...
/**
 * Created by hehongcan on 2017/4/5.
 */
...
public class FlikerProgressBar extends View implements Runnable{
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            textSize = (int) ta.getDimension(R.styleable.FlikerProgressBar_filkertextSize, 12);
            ...
            radius = (int) ta.getDimension(R.styleable.FlikerProgressBar_progressRadius, 0);
            borderWidth = (int) ta.getDimension(R.styleable.FlikerProgressBar_progressBorderWidth, 1);
        } finally {
            ta.recycle();
        }
    }
