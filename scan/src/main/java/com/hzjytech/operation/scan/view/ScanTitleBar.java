...
/**
 * To create more visit https://github.com/bacy/titlebar
 */
public class ScanTitleBar extends ViewGroup implements View.OnClickListener {
    ...
    public ScanTitleBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ScanTitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setTextSize(int textSize){
        if(textSize<DEFAULT_MAIN_TEXT_SIZE){
            mCenterText.setTextSize(textSize);
        }else{
            mCenterText.setTextSize(textSize);
        }
    }
